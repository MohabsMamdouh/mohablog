...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 29, 2022 at 11:32 PM
...
INSERT INTO `users` (`id`, `fullName`, `username`, `title`, `email`, `email_verified_at`, `address`, `phone`, `profile`, `profileImage`, `password`, `expYear`, `currentPosition`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Mohab Mamdouh Abd El-Twab', 'mohablog', 'Backend Developer PHP / Laravel', 'mohabmamdouh22@gmail.com', NULL, 'Cairo, El-Slam', '01156047032', 'Mohab is a backend developer PHP/Laravel, He has 1 year of experience in backend development websites, Develop functions with a good knowledge of Web Applications Development.', 'mohablog-1658841433.jpg', '$2y$10$3UzadoHYUSKdnnP0JrGMw.EbwG7yEB6/XXZ7m7G0WIpzMSKzAiZ1K', '1', 'Backend Developer PHP/Laravel', '3AGMSOjftbeYA9Se9ExyOPi6Tf0OwzxpHkDLQSVlAZSNlZDlmN6Jx6bCshst', NULL, '2022-07-26 11:17:13');
